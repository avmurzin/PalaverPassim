...
var create_palaver = {
		view:"form", id: "palaver_form", scroll:false, elements:[
                                      ...
                                      {view:"select", id:"type_select", name:"type" ,label:"Тип", value: "NORMAL", options: [{id:"NORMAL", value: "Поместить в расписание"}, {id:"TEMPLATE", value: "Сохранить как шаблон"}, {id:"PREPARED", value: "Поместить в стандартные мероприятия"}], labelAlign: 'left', on:{
                                          onChange:function(){
		                              ...
		                              { view:"datepicker", id: "timestart", timepicker:true, label:"Начало", name:"start", stringResult:false, format:"%d.%m.%Y %H:%i", on:{
		                            	  onChange:function(){
		                              ...
		                              { view:"datepicker", id: "timestop", timepicker:true, label:"Конец", name:"end", stringResult:false, format:"%d.%m.%Y %H:%i", on:{
                                          onChange:function(){
                                              update_form();
                                          }
                                          }  },
